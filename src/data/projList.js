...
{
  name: "RSVP App With ReactJS.",
  skills: "React.js | Javascript | CSS3 | HTML5 | JSX | ES6 | jest",
  downloadLink: "https://github.com/liamkande/React-RSVP-UI/archive/master.zip",
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/RSVP-App/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
  description: "Built a RSVP application with React, created event handlers to manage the state of the app, built a counter component to keep track of guests, used filters, map and other JavaScript methods. ",
  image: "images/thumbnail-SVG/thumbnail-3.svg"
},
{
  name: "Course Directory with React",
  skills: "React.js | React-Router4 | CSS3 | HTML5 | JSX ",
  downloadLink: "https://github.com/liamkande/Course-Directory-App-with-React/archive/master.zip",
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Course-Directory/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
  description: "Developed a Course Directory using React Router v4 to manage navigations, rendering of components including 404 error routes; worked with URL parameters as well as changing routes programmatically.",
...
{
  name: "ScoreBoard UI with React/Redux",
  skills: "React.js | Redux | JavaScript | CSS3 | JSX",
  downloadLink: "https://github.com/liamkande/React-Score-Board-App/archive/master.zip",
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/ScoreBoard-Redux/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
  description: "Developed an Score Board Web-app with ReactJS for playing board or card games, used Redux and localStorage to manage the state of my app as well as CallBack functions to handle different events.",
  image: "images/thumbnail-SVG/thumbnail-3.svg"
},
{
  name: "Travel Activity with React/Redux",
  skills: "React.js | Redux | JSX | SASS | Webpack | NodeJS",
  downloadLink: "https://github.com/liamkande/Travel-Activity-App_React-Redux/archive/master.zip",
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Travel-Day-Counter/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
  description: "Created an browser-based activity counter app with React, used Redux to manage state, used propTypes for checking props, added default data, worked with SASS, JXS and more.",
  image: "images/thumbnail-SVG/thumbnail-1.svg"
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/React-Calculator/index.html",
  boxClass: "col-md-4 col-lg-4 box-one boxwrapper text-center",
  pClass:"text-center detail",
  description: "Built an ios Calculator using ReactJS, JavaScript functions and methods, worked with CSS flexbox and related tools.",
  image: "images/thumbnail-SVG/thumbnail-3.svg"
},
{
  name: "placeHolder"
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Banner-Ad+/LiamKande_example.html",
  boxClass: "col-md-4 col-lg-4 box-two boxwrapper text-center",
  pClass:"text-center detail",
  description: "Developed a banner ad with Adobe Animate by creating graphics, photos, designs, and brought objects to life using animation and interactivity.",
...
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Collapsible-Component/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
  description: "Created a simple flexible, reusable collapsible component using ReactJS, SASS, and Bootstrap Classes.",
  image: "images/thumbnail-SVG/thumbnail-3.svg"
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Fetching-Data/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
  description: "Developed a Data Fetching UI to demonstrate Fetching methods from an API with ReactJS, used ES6 syntax functions as well as HTML5 Cross Browser Polyfills.",
  image: "images/thumbnail-SVG/thumbnail-1.svg"
},
{
  name: "placeHolder"
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/UI-React/index.html",
  boxClass: "col-md-4 col-lg-4 box-one boxwrapper text-center",
  pClass:"text-center detail",
...
{
  name: "Responsive Bootstrap Design",
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Responsive-Design-Bootstrap/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Responsive-Hotel/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  name: "SEO Audit",
  skills: "SEO",
  downloadLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P4_-_SEO_Audit__Project_Template_Slides.pdf",
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P4_-_SEO_Audit__Project_Template_Slides.pdf",
  boxClass: "col-md-4 col-lg-4 box-two boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  downloadLink: "https://github.com/liamkande/Arcade-game_Frogger-Clone/archive/master.zipy",
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Arcade-Game-Clone/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Bulletin-Board/index.html",
  boxClass: "col-md-4 col-lg-4 box-one boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Website-Optimization/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Interactive-Resume/index.html",
  boxClass: "col-md-4 col-lg-4 box-one boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  downloadLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P3_-_Part_2-_Project_Template_Slides.pdf",
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P3_-_Part_2-_Project_Template_Slides.pdf",
  boxClass: "col-md-4 col-lg-4 box-two boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Anolog-Clock/index.html",
  boxClass: "col-md-4 col-lg-4 box-three boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  downloadLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P5_-Part_2.pdf",
  previewLink:"https://s3.us-east-2.amazonaws.com/liamkande.com/projects/P5_-Part_2.pdf",
  boxClass: "col-md-4 col-lg-4 box-two boxwrapper text-center",
  pClass:"text-center detail",
...
},
{
  ...
  previewLink: "https://s3.us-east-2.amazonaws.com/liamkande.com/preview/Typing-Speed-Tester/index.html",
  boxClass: "col-md-4 col-lg-4 box-four boxwrapper text-center",
  pClass:"text-center detail",
